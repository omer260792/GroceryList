//
//  GroceryListColletionViewController.swift
//  GroceryList
//
...
class GroceryListTableViewController: UITableViewController {
    ...
    let ref = Database.database().reference(withPath: "generalCategory")
        ...
        let saveAction = UIAlertAction(title: "Save", style: .default) { _ in
            guard let textField = alert.textFields?.first,
                let text = textField.text else { return }
                 ...
                 let groceryItem = GroceryItem(name: text, content: "", date: "", tabCategory: "", generalCategory: "", image: "", isSend: true, isColor: true, isCompleted: false, uid: "")
