...
class GeneralListViewController: UITableViewController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        userCountBarButtonItem = UIBarButtonItem(title: "8",
                                                 style: .plain,
                                                 target: self,
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = groceryItem.name + names
    ...
    @IBAction func addButtonDidTouch(_ sender: AnyObject) {
        ...
        let saveAction = UIAlertAction(title: "Save", style: .default) { _ in
            ...
            let groceryItem = GroceryItem(name: text, content: "", date: "", tabCategory: tabCategory, generalCategory: "", image: "", isSend: true, isColor: true, isCompleted: false, uid: "")
